...
import dpd4eclipse.visualization.DesignPatternDiagram;
import dpd4eclipse.visualization.DesignPatternVisualizationData;
import dpd4eclipse.visualization.ZoomAction;
import dpd4eclipse.visualization.ZoomInputAction;

public class DesignPatternVisualization extends ViewPart {

	public static final String ID = "dpd4eclipse.views.DesignPatternVisualization";
	...
	public void createPartControl(Composite parent) {
		...
		DesignPatternVisualizationData data = VisualizationDataSingleton.getData();

		if(data != null) {
			DesignPatternDiagram diagram = new DesignPatternDiagram(data);
